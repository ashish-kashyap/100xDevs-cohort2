...
const app = express();
app.use(bodyParser.json()); //automatically parses incoming JSON requests and makes them available in req.body
...
// --- 4. PUT /todos/:id - Update todo by ID ---
...
// --- 5. DELETE /todos/:id - Delete todo by ID ---
